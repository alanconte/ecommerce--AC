...
import CartListDetail from '../../Cart/CartListDetail';
import CartListDetail2 from '../../Cart/CartListDetail2';
...
const FormCheckout2 = () => {
    ...
    const fRefreshStock = async () => {
      ...
      const collectionStock = collection(db,'instrumentos')
      const queryStockRefresh = query(
           collectionStock, where(documentId(), 'in', cart.map(it=> it.id))
           )
       ...
       <div className="grid-formik">
        ...
        <Formik
          initialValues={
              ...
              confirmEmail: 'ejemplo@email.com',
              phone: '', 
              confirmPhone: ''
              }
            }
